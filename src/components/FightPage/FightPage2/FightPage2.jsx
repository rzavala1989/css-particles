...
export const FightPage2 = () => {
  ...
  const [currentEnemyImage, setEnemyImage] = useState(ashleighIdle);
  ...
  const completeTask = () => {
    ...
    if (numberOfTasks < 3) {
      setEnemyImage(ashleighDamageThree);
    } else if (numberOfTasks < 6) {
      setEnemyImage(ashleighDamageTwo);
    } else {
      setEnemyImage(ashleighDamageOne);
    }
  };
      ...
      <div className='root'>
        ...
        <div className='right-side'>
          <div className='health-div'>
            <HealthBar health={health} name='ASHLEIGH' />
          </div>
