...
export const FightPage3 = () => {
  ...
  const [currentEnemyImage, setEnemyImage] = useState(bonkcoIdle);
  ...
  const completeTask = () => {
    ...
    if (numberOfTasks < 3) {
      setEnemyImage(bonkcoDamageThree);
    } else if (numberOfTasks < 6) {
      setEnemyImage(bonkcoDamageTwo);
    } else {
      setEnemyImage(bonkcoDamageOne);
    }
  };
      ...
      <div className='root'>
        ...
        <div className='right-side'>
          <div className='health-div'>
            <HealthBar health={health} name='BONKCO' />
          </div>
